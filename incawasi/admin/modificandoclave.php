...
$clave = quitar($_POST["laclave"]); 
$query2="UPDATE usuarios set nombre_apellidos_usu= '$nombre',email_usuario='$email',nick_usuario='$nick',pass_usuario='$clave' where idusuarios = '$a_editar' ";
