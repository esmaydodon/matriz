...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center"> 
 ...
 <input name="id" type="hidden" id="id" value="<?php echo $v['id'] ?>"> </td> <!--campo oculto $v['id']-->
...
<?php }else{ ?> 
<p align="center"> <span class="prod">No hay productos seleccionados</span> <a href="catalogo.php?<?php echo SID;?>"><img src="img/actualizar.gif" width="13" height="13" border="0"></a> 
 <?php }?> 
</p> 
</body> 
</html> 