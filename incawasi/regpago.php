...
<input type="hidden" name="shipping" value="0"> <!--: Es el costo de envío-->
<input type="hidden" name="cbt" value="Presione aquí para volver a www.yes.com >>"> <!--Es el mensaje que verá en Paypal el usuario al finalizar el proceso de pago.  -->
<input type="hidden" name="cmd" value="_xclick"> 
 <input type="hidden" name="rm" value="2"><!-- Es el método con que Paypal devolverá las variables a la página ipn_success.php (1 es get 2 es post).--> 
 <input type="hidden" name="bn" value="nombre de la empresa vendedora"> <!--: Esta es la identificación de la integración que estamos haciendo-->
<input type="hidden" name="business" value="marlon@hotmail.com"><!-- Es el mail que el vendedor registró en su cuenta de Paypal. -->
<input type="hidden" name="item_name" value="<?php echo $products2; ?>"> <!--Es el detalle de lo que estamos vendiendo.  -->
<input type="hidden" name="item_number" value="Nombre del comprador">  <!--Aquí va el número de item. Podemos completarlo con un código de operación o utilizarlo para otra cosa (personalmente lo utilizo para guardar el nombre del comprador, ya que cuando la operación se realiza y Paypal automáticamente genera sendos mails al vendedor y al comprador, suele incluir este dato y al vendedor le sirve para saber rápidamente quien es el comprador).  -->
<input type="hidden" name="amount" value="<?php echo number_format($_GET['costo'],2) ?>">  <!--Es el importe total de la operación. -->
<input type="hidden" name="custom" value="<?php echo $_GET['costo'] ?>">  <!--Aquí podemos colocar cualquier variable que luego necesitemos para realizar nuestros procesos cuando Paypal redireccione al usuario a nuestra página de éxito.  -->
<input type="hidden" name="currency_code" value="USD">  <!-- La moneda en que expresamos los valores:USD,GBP,JPY,CAD,EUR-->
<input type="hidden" name="image_url" value="">  <!--Es la ruta absoluta de la imagen que aparecerá en la cabecera de la página de Paypal cuando el comprador esté pagando -->  
<input type="hidden" name="return" value="http://www.nuestrodominio.com/ipn_success.php">  <!-- Aquí colocaremos la ruta absoluta a la página ipn_success.php. Es la página a la que Paypal redirecciona al comprador si el pago se realiza correctamente-->
<input type="hidden" name="cancel_return" value="http://www.nuestrodominio.com/ipn_error.php">  <!--	Aquí colocaremos la ruta absoluta a la página ipn_error.php. Es la página a la que Paypal redirecciona al comprador si el pago no se realiza correctamente.  -->
