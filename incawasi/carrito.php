...
.noti-pie{clear:both; font-size:12px; font-family:"Trebuchet MS", Arial, Helvetica, sans-serif; text-align:justify;}
...
p { padding:10px; 0px; font-family:"Trebuchet MS", Arial, Helvetica, sans-serif;font-size: 14px;}
</style> 
</head>
...
<!-- end #header -->
  ...
  <div id="mainContent">
    <div id="contenedor_carrito"> <p> Make a meaningful gift to family and friends by donating to Cajamarca's most disadvantaged youth in their honor. Your gift will help these children have access to education, nutritious meals, and medical attention. You can choose among different gifts and give Incawasi children new apportunities in their life.</p>
    <? 
	include("muestraArticulos.php");
		/*
		$consulta_productos=dime("select idproductos,nombre_producto,descripcion_producto,precio,ruta_img1 from productos order by idproductos desc "); while ($producto=mysql_fetch_array($consulta_productos)){
	;
$cadena = ereg_replace( "([     ]+)","%20",$producto['ruta_img1']);// desaparecer espacio en blanco y cjuntar  as caracteres
	echo"<div class='noti'>
              <h2>".$producto['nombre_producto'] ."</h2>
                 <div  ><img  src=admin/".$cadena." width='150px' height='150px'></div>
                ".$producto['descripcion_producto']."<br />
              <br /><h2>precio:".$producto['precio']."</h2>
...
<div class="parrafo"></div>
  ...
  <!--<div class="bandera"><img src="imagenes/alemania.png" width="15" height="10" /> <img src="imagenes/ingles.png" width="15" height="10" /> <img src="imagenes/peru.png" width="15" height="10" /> <img src="imagenes/italia.png" width="15" height="10" /> <img src="imagenes/japon.png" width="15" height="10" /></div>-->
    <div class="derecha">
      <ul>
        <!--<li> <a href="incawasi/index.html">/a></li> -->
