...
<!-- end #header -->
  ...
  <div id="mainContent">
    <div style="padding:10px 0px 0px 0px">
      ...
      <div style=" padding:10px 0px 10px 300px; font-size:24px; -moz-border-radius:3px;  border-radius:3px;"> <a href="carrito.php" style=" text-decoration:none   ;cursor:pointer; background:#7da7d9;	">Ver Carrito</a></div>
      <div style=" padding:10px 0px 10px 300px; font-size:24px; -moz-border-radius:3px;  border-radius:3px;"><a href="admin/panel2.php"  style="text-decoration:none;cursor:pointer; background:#7da7d9;	">Administrar Carrito</a></div> 
    </div>
<div class="parrafo">
